<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes409_FormMetabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes409_FormMetabox extends Wbcr_FactoryMetaboxes409_Metabox {
			...
			/**
			 * @var Wbcr_FactoryForms430_MetaValueProvider
			 */
			protected $provider;
			...
			private function getForm($post_id = null)
			{
				...
				$this->provider = new Wbcr_FactoryForms430_MetaValueProvider(array(
					'scope' => $this->scope
				));
				...
				// creating a form
				$form = new Wbcr_FactoryForms430_Form(array(
					'scope' => $this->scope,
					'name' => $this->id
				), $this->plugin);
			...
			public function html()
			{
				...
				echo '<div class="factory-form-metabox factory-bootstrap-433">';
			 ...
			 */
			public function beforeForm(Wbcr_FactoryForms430_Form $form)
			{
				return;
			}
			 ...
			 */
			public function afterForm(Wbcr_FactoryForms430_Form $form)
			{
				return;
			}
