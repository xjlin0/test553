<?php
	...
	if( !class_exists('Wbcr_FactoryMetaboxes409_Metabox') ) {
		...
		abstract class Wbcr_FactoryMetaboxes409_Metabox {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_Factory432_ScriptList
			 */
			public $scripts;
			 ...
			 *
			 * @since 1.0.0
			 * @param Factory432_ScriptList $scripts A set of scripts to include.
			 * @param Factory432_StyleList $styles A set of style to include.
			 * @return void
			 */
