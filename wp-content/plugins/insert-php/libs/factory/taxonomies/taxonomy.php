<?php
	...
	//add_action('factory_432_plugin_activation', 'FactoryTaxonomy000::activationHook');
	//add_action('factory_432_plugin_deactivation', 'FactoryTaxonomy000::deactivationHook');
