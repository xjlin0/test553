<div class="projects_masonry_wrapper <?php implode(' ', $portfolio_holder_universal_classes); ?> ">
    <?php echo bridge_core_get_shortcode_template_part( 'templates/parts/filter', '_portfolio-list', '', $params ); ?>

    <div class="projects_masonry_holder portfolio_main_holder portfolio_masonry_gallery_with_space gs<?php esc_attr_e($grid_size);?> <?php esc_attr_e($portfolio_loading_class);?>">
